...
files_to_verify = [
    os.path.join('harness2.c'),
    os.path.join('exercise_1a.txt'),
    os.path.join('exercise_1b_asan_report.txt'),
    os.path.join('exercise_1b_asan_testcase.txt'),
    os.path.join('exercise_1b_afl.txt'),
    os.path.join('exercise_1d_asan_report.txt'),
    os.path.join('exercise_1d_asan_testcase.txt'),
    os.path.join('exercise_1d_afl.txt'),
    # path to file    
]
