...
files_to_verify = [
    ...
    os.path.join('results_1b.py'),
    os.path.join('plots.png'),
    os.path.join('html_grammar.py'),
    # path to file    
]

variables_to_verify = [
    # tuple of (package, var name)
    ('html_grammar', 'HTML_GRAMMAR'),
] + [('exercise_2', f'Q{i}') for i in range(1, 11)]

functions_to_verify = [
    ('exercise_1a', 'get_random_fuzzer', 0),
    ('exercise_1a', 'get_grammar_fuzzer', 1),
    ('exercise_1a', 'get_mutation_fuzzer', 1),
    ('exercise_1a', 'get_greybox_fuzzer', 1),
    ('exercise_1a', 'get_lang_fuzzer', 2),
    ('exercise_1a', 'get_greybox_grammar_fuzzer', 2)
]
